...
export default function toilet_repair() {
  return (
    <div className="blog-post">
      <h1>Toilet Repair: What You Need to Know</h1>
      <p>At PD Plumbing, we specialize in toilet repair to keep your home running smoothly. Fixy and the crew are always ready to deliver fast, friendly service when you need it most.</p>
