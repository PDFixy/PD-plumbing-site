...
export default function drain_cleaning() {
  return (
    <div className="blog-post">
      <h1>Drain Cleaning: What You Need to Know</h1>
      <p>At PD Plumbing, we specialize in drain cleaning to keep your home running smoothly. Fixy and the crew are always ready to deliver fast, friendly service when you need it most.</p>
