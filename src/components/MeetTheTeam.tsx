...
const teamMembers = [
  ...
  },
  {
    ...
    summary: 'Skilled HVAC tech with a focus on precision, leadership, and customer-first problem solving.',
  ...
  },
  {
    ...
    summary: 'General Manager. Licensed plumber with background in MMA, accounting, and music. Leads with integrity.',
  ...
  },
  {
    ...
    summary: 'Customer Comfort Advisor. Trusted plumber, family man, and award-winning leader at PD.',
  ...
  },
  {
    ...
    summary: 'Apprentice plumber with a hands-on mindset. Passionate about learning and leadership.',
  ...
  },
  {
    ...
    summary: 'Founder. Master Plumber, entrepreneur, falconer, and industry leader with 30+ years of experience.',
  ...
  },
  {
    ...
    summary: 'Dispatcher and operations MVP. Calm under pressure, heart of the crew.',
  ...
  },
  {
    ...
    summary: 'Apprentice with positive energy, coachable spirit, and big potential.',
  ...
  },
  {
    ...
    summary: 'HVAC tech and former chef with unmatched work ethic and character.',
