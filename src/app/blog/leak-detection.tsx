...
export default function LeakDetection() {
  return (
    <>
      <Head>
        <title>How to Detect a Leak Before It Becomes a Disaster | PD Plumbing</title>
        <meta
          name="description"
          content="How to Detect a Leak Before It Becomes a Disaster from PD Plumbing. Learn how to solve problems, prevent issues, and improve your home systems."
        />
      </Head>

      <main className="px-4 sm:px-8 lg:px-16 py-10">
        <h1 className="text-4xl font-bold mb-6">How to Detect a Leak Before It Becomes a Disaster</h1>

        <Image
          src="/assets/images/plumbing-van-company-logo.jpg"
          alt="How to Detect a Leak Before It Becomes a Disaster"
          width=800
          height=400
        ...
        <p className="text-lg mb-4 text-gray-700">
          How to Detect a Leak Before It Becomes a Disaster – Learn how PD Plumbing can help you handle this common home concern with confidence.
        </p>
        ...
        <p className="text-lg font-semibold text-gray-800 mt-10 mb-4">
          Have questions about how to detect a leak before it becomes a disaster? Book your service with Fixy and the PD team today.
        </p>
