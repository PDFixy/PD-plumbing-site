...
export default function WaterFiltration() {
  return (
    <>
      <Head>
        <title>Clean Water Starts Here: Whole-House Filtration Tips | PD Plumbing</title>
        <meta
          name="description"
      ...
      <main className="px-4 sm:px-8 lg:px-16 py-10">
        <h1 className="text-4xl font-bold mb-6">Clean Water Starts Here: Whole-House Filtration Tips</h1>
        ...
        <p className="text-lg mb-4 text-gray-700">
          Clean Water Starts Here: Whole-House Filtration Tips – Learn how PD Plumbing can help you handle this common home concern with confidence.
        </p>
