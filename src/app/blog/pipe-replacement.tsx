...
export default function PipeReplacement() {
  return (
    <>
      <Head>
        <title>When to Replace Old Plumbing Pipes in Your Home | PD Plumbing</title>
        <meta
          name="description"
      ...
      <main className="px-4 sm:px-8 lg:px-16 py-10">
        <h1 className="text-4xl font-bold mb-6">When to Replace Old Plumbing Pipes in Your Home</h1>
        ...
        <p className="text-lg mb-4 text-gray-700">
          When to Replace Old Plumbing Pipes in Your Home – Learn how PD Plumbing can help you handle this common home concern with confidence.
        </p>
        ...
        <p className="text-lg font-semibold text-gray-800 mt-10 mb-4">
          Have questions about when to replace old plumbing pipes in your home? Book your service with Fixy and the PD team today.
        </p>
