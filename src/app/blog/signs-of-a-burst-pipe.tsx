  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="How to catch a burst before it floods your home." />
      </Head>

      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-6 text-center">Top Signs of a Burst Pipe</h1>
        <p className="text-lg text-center mb-4">How to catch a burst before it floods your home.</p>
