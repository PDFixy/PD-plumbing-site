...
export default function KitchenPlumbing() {
  return (
    <>
      <Head>
        <title>Kitchen Plumbing Upgrades That Make Life Easier | PD Plumbing</title>
        <meta
          name="description"
          content="Kitchen Plumbing Upgrades That Make Life Easier from PD Plumbing. Learn how to solve problems, prevent issues, and improve your home systems."
        />
      </Head>

      <main className="px-4 sm:px-8 lg:px-16 py-10">
        <h1 className="text-4xl font-bold mb-6">Kitchen Plumbing Upgrades That Make Life Easier</h1>

        <Image
          src="/assets/images/plumbing-van-company-logo.jpg"
          alt="Kitchen Plumbing Upgrades That Make Life Easier"
          width=800
          height=400
        ...
        <p className="text-lg mb-4 text-gray-700">
          Kitchen Plumbing Upgrades That Make Life Easier – Learn how PD Plumbing can help you handle this common home concern with confidence.
        </p>
        ...
        <p className="text-lg font-semibold text-gray-800 mt-10 mb-4">
          Have questions about kitchen plumbing upgrades that make life easier? Book your service with Fixy and the PD team today.
        </p>
