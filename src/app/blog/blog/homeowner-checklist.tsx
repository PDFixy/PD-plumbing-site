...
export default function BlogPost() {
  return (
    <>
      <Head>
        <title>Homeowner Plumbing Checklist | PD Plumbing</title>
        <meta name="description" content="Essential maintenance for stress-free plumbing." />
      </Head>

      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-6 text-center">Homeowner Plumbing Checklist</h1>
        <p className="text-lg text-center mb-4">Essential maintenance for stress-free plumbing.</p>
