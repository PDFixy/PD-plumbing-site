  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Tips to keep your kitchen running like a dream." />
      </Head>

      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-6 text-center">Fixy’s Top Kitchen Plumbing Tips</h1>
        <p className="text-lg text-center mb-4">Tips to keep your kitchen running like a dream.</p>
