...
export default function BlogPost() {
  return (
    <>
      <Head>
        <title>Gas Leak Safety Tips | PD Plumbing</title>
        <meta name="description" content="What to do when you smell gas — and why speed matters." />
      </Head>

      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-6 text-center">Gas Leak Safety Tips</h1>
        <p className="text-lg text-center mb-4">What to do when you smell gas — and why speed matters.</p>
