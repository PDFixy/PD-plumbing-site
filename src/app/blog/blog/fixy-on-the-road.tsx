...
export default function BlogPost() {
  return (
    <>
      <Head>
        <title>Fixy on the Road | PD Plumbing</title>
        <meta name="description" content="Catch Fixy around town and learn how our team’s always moving." />
      </Head>

      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-6 text-center">Fixy on the Road</h1>
        <p className="text-lg text-center mb-4">Catch Fixy around town and learn how our team’s always moving.</p>

        <img src="/assets/images/fixy/fixy_waving.png" alt="Fixy Mascot" className="mx-auto mb-8 w-60" />
