  ...
  return (
    <main className="px-4 sm:px-8 lg:px-16 py-10 space-y-12">
      <section className="text-center">
        ...
        />
        <h1 className="text-3xl sm:text-4xl font-bold mt-6">Sump Pump</h1>
        <p className="mt-4 text-lg text-gray-700">
          Need help with sump pump? PD Plumbing is your fast, friendly, and local expert.
        </p>
        <CallToAction />
      </section>

      <section className="max-w-3xl mx-auto space-y-6">
        <h2 className="text-2xl font-semibold">Why Choose Us for Sump Pump</h2>
