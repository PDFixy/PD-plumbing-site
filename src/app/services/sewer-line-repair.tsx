...
export default function Page() {
  return (
    <Layout>
      <Head>
        <title>Sewer Line Repair | PD Plumbing</title>
        <meta name="description" content="Sewer Line Repair services by PD Plumbing in Wichita. Fast, friendly, expert plumbing and HVAC you can count on. Same-day service available!" />
      </Head>
      <section className="py-8 px-4 max-w-4xl mx-auto">
        <Image src="/assets/images/team/team-photo.jpg" alt="PD Plumbing Team" width={1200} height={500} />
        <h1 className="text-3xl font-bold my-6">Sewer Line Repair</h1>
        <p>Looking for reliable sewer line repair in Wichita and surrounding areas? PD Plumbing offers expert, same-day service from a friendly local team. Whether you're dealing with a leak, upgrade, or emergency, we’re ready to help—fast.</p>
