  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-12 space-y-16">
      ...
      <section className="text-center">
        <h1 className="text-4xl font-extrabold text-blue-900 mb-4">Drain Cleaning in Wichita</h1>
      ...
      <section className="bg-gray-50 rounded-lg p-6">
        <h2 className="text-2xl font-semibold mb-4">Don’t Let a Clog Become a Flood</h2>
        <p className="text-gray-700">
          Ignoring a slow drain can lead to backups, water damage, and bigger repair bills. Let Fixy take care of it today — fast, clean, and friendly.
        </p>
      </section>
      ...
      <section className="bg-white shadow-md rounded-lg p-6 text-center">
        <h2 className="text-2xl font-bold mb-4">Real Wichita Customers, Real Results</h2>
